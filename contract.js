...
const init = async (e) => {
  // if using node js need to wrap in async
...
const allGoalsButton = document.querySelector(".checkAllGoalsButton"); //assigns the the checkAllGoalsButton class to a constant

allGoalsButton.addEventListener("click", () => {
  // listens for the click of the check all goals button
  contract.methods
    .getAllGoals(currentAccount)
    .call()
    .then((result) => {
      console.log(result);
    })
